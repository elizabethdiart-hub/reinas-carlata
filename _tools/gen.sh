...
METADESC[body-burdeos-real]="Body de lencería burdeos de encaje floral, con escote en V, cintura marcada y herrajes dorados. Escríbenos y te avisamos cuando vuelva."
...
METADESC[bralette-marfil-sueno]="Bralette de encaje marfil sin aro, triangular, con pestaña festoneada y tirantes regulables. Escríbenos y te avisamos cuando vuelva."
...
METADESC[pijama-saten-champagne]="Pijama de satén champagne de dos piezas: top con escote en V y encaje, y short con pretina elástica. Escríbenos y te avisamos cuando vuelva."
...
$(nota_html "$slug")
        ...
        <p>Llega en un empaque lindo, listo para obsequiar: la prenda va protegida en una bolsita de tul con nuestro logo.</p>
      </div>
    </div>
  </div>
</section>
